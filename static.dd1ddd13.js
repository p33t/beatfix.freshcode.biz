...
var _screenshot = __webpack_require__(26);
...
exports.default = (0, _reactStatic.withSiteData)(function () {
    return _react2.default.createElement(
        ...
        _react2.default.createElement('img', { src: _logo2.default, alt: 'logo', style: { display: 'block', margin: '0 auto' } }),
        _react2.default.createElement(
            'h3',
            null,
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'a',
                { href: 'https://beatfix-app.freshcode.biz' },
                _react2.default.createElement('img', { src: _screenshot2.default, alt: 'screenshot', style: { display: 'block', margin: '0 auto' } }),
                _react2.default.createElement(
                    'span',
                    null,
                    'Click to launch'
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'li',
                null,
                'Visual display of tempo (suitable for a dark environment)'
            ),
            _react2.default.createElement(
                'li',
                null,
                'Pick up the beat at any point in a bar/cycle (no need to wait for a new bar)'
            ),
            _react2.default.createElement(
                'li',
                null,
                'Provides a visual reference to assess accuracy of an ambient tempo'
            )
        ),
        _react2.default.createElement(
            'h3',
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'li',
                null,
                'Check the ambient tempo with an extended glance'
            ),
            _react2.default.createElement(
                'li',
                null,
                'Incrementally correct the ambient tempo'
            ),
            _react2.default.createElement(
                'li',
                null,
                'Monitor his/her precision at a glance'
            )
        )
    );
});
...
exports.default = function () {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'p',
            null,
            'Hi, my name is Peter, an amateur drummer for over 10 years. I\'ve never used a \'click track\' and instead rely on a visual metronome when onstage to ensure correct tempo, especially to start a song. A performance metronome has a number of different requirements to a conventional metronome. In general, it needs to be passive, flexible, quickly adjustable and work in the dark.'
        ),
        _react2.default.createElement(
            'p',
            null,
            ...
            ' metronome is very good for performance usage although not perfect. Also, using the MR600, I found I could monitor and fix my tempo during a performance if necessary.'
        ),
        _react2.default.createElement(
            'p',
            null,
            'Being a software developer by trade, I thought I\'d come up with my own metronome. ',
            _react2.default.createElement(_Product2.default, null),
            ' is the second generation solution. The first was ',
            _react2.default.createElement(
                'a',
                { href: 'https://sourceforge.net/projects/multi-phasemetr/' },
                'Multi-phase Metronome'
            ),
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'a',
                { href: 'https://groups.google.com/forum/#!forum/beatfixlive-announcements' },
                'Join the mailing list'
            ),
            ' to receive an email when a new version is released.'
        ),
        _react2.default.createElement(
            'h2',
            null,
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'a',
                { href: 'https://subversion.assembla.com/svn/freshcode_public/beatfix.live/app/RELEASE_NOTES.txt' },
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(_Product2.default, null),
            ' is a ',
            _react2.default.createElement(_Provider2.default, null),
            ' innovation'
        )
    );
};
...
var t_0 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/pwl/work/assembla/beatfix.live/www/dist/react-static-routes.js',
  load: function load() {
...
var t_1 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  id: '../src/containers/Features',
  file: '/home/pwl/work/assembla/beatfix.live/www/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 7)), (0, _importCss3.default)('src/containers/Features', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/containers/Features');
  },
  resolve: function resolve() {
    return /*require.resolve*/(7);
  },
  chunkName: function chunkName() {
    return 'src/containers/Features';
  }
}), universalOptions);
var t_2 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  id: '../src/containers/Usage',
  file: '/home/pwl/work/assembla/beatfix.live/www/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 8)), (0, _importCss3.default)('src/containers/Usage', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/containers/Usage');
  },
  resolve: function resolve() {
    return /*require.resolve*/(8);
  },
  chunkName: function chunkName() {
    return 'src/containers/Usage';
  }
}), universalOptions);
...
module.exports = __webpack_require__.p + "static/screenshot.f01105b8.png";
...
// module
exports.push([module.i, "body{font-family:HelveticaNeue-Light,Helvetica Neue Light,Helvetica Neue,Helvetica,Arial,Lucida Grande,sans-serif;font-weight:300;font-size:16px;color:#d3d3d3;margin:0;padding:0;background:#000}a{text-decoration:none;color:#add8e6;font-weight:700}img{max-width:100%}nav{width:100%;background:dimgrey}nav a{color:#fff;display:inline-block}.content,nav a{padding:1rem}", ""]);
